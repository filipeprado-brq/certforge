...
**Plans:** 4 plans
Plans:
- [ ] 06-01-PLAN.md — Add optional hasSnippet to Question type + raise content.test.ts to >=120 / per-domain mins / each scenario >=8 / hasSnippet >=15 (TDD RED gate)
...
| 6. Question Bank Expansion | 0/4 | Planned | - |
